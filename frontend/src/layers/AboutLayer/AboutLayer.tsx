      ...
      <div className={cls.wrapper}>
        ...
        <W_ScrollFadeBox className={cls.mobileScroll} height="100%">
          <p className={cls.mobileText}>
            Мне нравится создавать, и&nbsp;предметы, которые я&nbsp;создаю,
            получают какое-то одобрение от&nbsp;моего окружения. Устраиваться
            же&nbsp;на&nbsp;работу&nbsp;— просто самое отвратное для меня дело;
            это как школа, только еще хуже. И&nbsp;я&nbsp;подумал, что могу
            попробовать монетизировать свое увлечение.
            <br />
            <br />
            ...
            заменять уже и&nbsp;так обязательные вещи на&nbsp;себя,
            на&nbsp;веселый вариант этих вещей.
            <br />
            <br />
            Ну и&nbsp;качество, это дефолт. Важно, чтобы их&nbsp;жизненный цикл
            был адекватным для подобных предметов. Хочу, чтобы эти предметы
            ...
            я&nbsp;использую те,&nbsp;которые мне сейчас доступнее всего.
            У&nbsp;меня нет завода или промышленных станков, я&nbsp;создаю
            те&nbsp;предметы, которые могу создать в&nbsp;рамках своих финансов
            и&nbsp;физических возможностей.
            <br />
            <br />
            Я начал осваивать кожу, как один из&nbsp;доступных вариантов
            создания предмета, и&nbsp;в&nbsp;этот момент создал мешочек. Поэтому
            мешочек стал кожаным. Если бы я&nbsp;осваивал фрезерный станок,
            то&nbsp;я&nbsp;бы&nbsp;сделал какой-то предмет, который создается
            с&nbsp;помощью фрезеровки.
            <br />
            <br />
            Так что, давайте я&nbsp;вам мешочки (и не только),
            а&nbsp;вы&nbsp;мне возможность не&nbsp;работать на&nbsp;кого-то?
