...
export function buildConfirmationOrderMail(
  ...
  const text = [
    ...
    `Трек-номер для отслеживания: ${shipment.trackingNumber ? shipment.trackingNumber : "Какая-то ошибка, не получили номер для отсеживания посылки. Напишите мне в телеграмм или на почту, разберемся."}`,
    ...
    "",
    "Если вы хотите что-то уточнить, или где-то есть ошибки, напишите ответное письмо на эту же почту, или в телеграмм (отвечу быстрее): @umni0enivibly",
    "",
